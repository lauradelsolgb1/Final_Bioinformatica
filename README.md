...
# 8) FILTRADO ESTRICTO SEGÚN CRITERIOS DEL PAPER, Criterios: |log2FC| ≥ log2(1.5) = 0.585 AND padj < 0.01\n\n"
...
p3 <- EnhancedVolcano(res,
                      ...
                      legendIconSize = 4.0,
                      drawConnectors = TRUE,
                      widthConnectors = 0.3,        # Controla cuántas etiquetas mostrar
                      xlim = c(-14, 14),
                      ylim = c(0, 200))
print(p3)
